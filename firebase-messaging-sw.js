// Florián – FCM service worker (push notifikace)
// Vlastní úzký scope (/florian/fcm/), nekoliduje s offline sw.js.
...
const ICON = '/florian/icon-192.png';
const APP_URL = 'https://pkobelka.github.io/florian/';
...
messaging.onBackgroundMessage(payload => {
  const title = payload.data?.title || 'Florián';
