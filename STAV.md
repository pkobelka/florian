...
**Nejbližší hydranty: hodnoty v seznamu + rychlý přehled** (v1.224)
   ...
   - **Celá karta** z přehledu smí až přes celý displej (`.card.full` = max-height 100dvh; v1.237 výška podle obsahu; v1.238 okno uprostřed obrazovky; v1.239 na PC/tabletu (≥1025 px) zoom 1,5, šířka dle okna).
